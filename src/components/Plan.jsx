  ...
  return (
    <div className='text-purple-950 max-w-[1400px] m-auto py-16 px-4 grid lg:grid-cols-2 gap-1'>
      ...
      <div className="flex flex-col h-full justify-center align-center p-10">
        ...
        <p className='text-2xl py-6'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Veritatis, ipsum.</p>
        <p className='text-2xl py-6'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Corporis, architecto similique! Aut amet earum, hic asperiores suscipit perferendis nobis iste.</p>
        <div className='pb-6'>
